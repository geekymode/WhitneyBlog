...
```{r figWall, fig.margin = TRUE, fig.width= 8, fig.height= 8, fig.cap = "Waterfall beauty. *ആരുടെ മായാമോഹമായ് ആരുടെ രാഗഭാവമായ് ആയിരം വർ‌ണ്ണരാജികളിൽ ഗാനമുണർത്തും ശ്രുതി മുഴങ്ങി..*", message=TRUE, cache=TRUE, echo=FALSE, out.width='100%'}
