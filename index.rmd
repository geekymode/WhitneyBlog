...
```{r figBlueBird2, fig.margin = TRUE, fig.width= 8, fig.height= 8, fig.cap = "She turns and insists on this pose. I happily oblige and click!", message=TRUE, cache=TRUE, echo=FALSE, out.width='100%'}
